"""Path registry for the final-paper S2S analysis.
...
class StudyPaths:
    """Resolved paths used by this clean paper branch."""
...
def foundation_paths(paths: StudyPaths | None = None) -> dict[str, Path]:
    """Small set of paths expected to exist before any paper analysis starts."""
