...
This is the paper-pipeline contract for the current clean branch.
...
<season>/08_final/                       reserved for final paper-ready outputs
```
...
excluded from this paper branch.
...
```text
outputs/s2s_paper_outputs/common/logs/slurm/
```

Runtime logs:

```text
outputs/s2s_paper_outputs/jjas2019/07_logs/slurm/
outputs/s2s_paper_outputs/jfm2026/07_logs/slurm/
```
