...
\usepackage{lmodern}
\usepackage{microtype}          % better justification; fixes most overfull hbox

%% --- Page layout --------------------------------------------------------
\usepackage[a4paper, top=1in, bottom=1in, left=1.1in, right=1.1in,
            headheight=14pt]{geometry}
\usepackage{setspace}
\setstretch{1.10}               % slight stretch for readability

%% --- Headers/footers ----------------------------------------------------
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\textit{Raj et al.\ --- S2S Benchmark over India}}
\fancyhead[R]{\small\textit{Draft \today}}
\fancyfoot[C]{\thepage}
...
\title{%
  \vspace{-0.8cm}
  {\color{linkblue}\rule{\linewidth}{2pt}}\\[0.5em]
  \LARGE\bfseries Benchmarking AI and Operational Subseasonal\\[0.2em]
  Forecast Systems over India:\\[0.3em]
  \large Weekly Precipitation and Circulation Skill\\
  in JFM~2026 and JJAS~2019\\[0.5em]
  {\color{linkblue}\rule{\linewidth}{0.6pt}}
}
