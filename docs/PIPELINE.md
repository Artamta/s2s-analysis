...
Clean, reviewable verification workflow for the India S2S benchmark.

## Scope

The benchmark has two case-study components:
...
`outputs/verification/<season>/02_processed/matched_init/`. The comparable
