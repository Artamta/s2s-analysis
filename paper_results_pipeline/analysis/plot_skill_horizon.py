...
for week_name, day_start, day_end in weeks:
    ...
    for init_date in init_dates:
        ...
        try:
            fuxi_base = f"/storage/raj.ayush/fuxi-init-jfm-weekely/output/{init_str}/member"
...
plt.tight_layout()
out_path = '/home/raj.ayush/s2s/s2s_anlysis/paper_results_pipeline/figures/verification/skill_horizon_z500.png'
