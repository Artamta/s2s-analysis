...
Run with the tested environment::
    ...
    /home/raj.ayush/.conda/envs/fuxi/bin/python fuxi_imerg_experiment.py
...
NEURAL_ADAPTER_SRC = HERE.parent / "neural_adapter" / "src"
...
IMPLEMENTATION_SOURCES = {
    ...
    "verify_fuxi_imerg_results.py": HERE / "verify_fuxi_imerg_results.py",
