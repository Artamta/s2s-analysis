...
init_date = '20260101'
out_path = '/home/raj.ayush/s2s/s2s_anlysis/analysis-code/verification/4model_z500_anomalies.png'
...
# ECMWF
print(" - ECMWF...")
ecmwf_cf = xr.open_dataset(f'/storage/raj.ayush/s2s-forecast-data/ecmwf/data/pl_cf_{init_date}.grib', engine='cfgrib')
...
# NCEP
print(" - NCEP...")
ncep_cf = xr.open_dataset(f'/storage/raj.ayush/s2s-forecast-data/ncep/data/pl_cf_{init_date}.grib', engine='cfgrib')
