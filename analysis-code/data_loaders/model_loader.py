...
def load_era5_ground_truth(start_date: str, end_date: str):
    ...
    # Open ERA5 cleanly
    ds = xr.open_mfdataset(f"/storage/raj.ayush/s2s-forecast-data/era5/data/era5_surface_z500_{start_date}.nc")
    return ds
...
def load_fuxi(init_date: str, member="00"):
    ...
    """
    base_path = f"/storage/raj.ayush/s2s-forecast-data/fuxi/output/{init_date}/member/{member}"
