...
> **📑 START HERE:** [`FIGURE_INDEX.md`](FIGURE_INDEX.md) is the authoritative, up-to-date
> index of **every** figure (fig01–fig26), the script that builds each, and its status.
> Companion docs: [`MJO_AUDIT.md`](MJO_AUDIT.md), [`REVIEWER_CAVEATS.md`](REVIEWER_CAVEATS.md).
>
> **Recent (2026-06-08):** added **basic absolute model-vs-truth** plots (fig21–24, per
> Prof. Singh), **probabilistic** RPSS/reliability (fig25–26), a corrected **MJO RMM skill**
> figure (fig20); fixed two bugs (mean-T2m climatology; MJO RMM normalization).
> Coastlines only, no political borders. The catalogue below covers fig01–17 only —
> see `FIGURE_INDEX.md` for the complete current set.
