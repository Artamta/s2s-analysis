...
init_date = '20260101'
out_path = '/home/raj.ayush/s2s/s2s_anlysis/paper_results_pipeline/verification/4model_t2m_anomalies.png'
...
# ECMWF
print(" - ECMWF...")
ecmwf_cf = xr.open_dataset(f'/storage/raj.ayush/benchmark(jfm)/ecmwf/data/sfc_cf_{init_date}.grib', engine='cfgrib', backend_kwargs={'filter_by_keys': {'shortName': '2t'}})
ecmwf_t2m = ecmwf_cf['t2m'].isel(step=slice(0, 42))
ecmwf_t2m = ecmwf_t2m.rename({'step': 'lead_time'})

# NCEP
print(" - NCEP...")
ncep_cf = xr.open_dataset(f'/storage/raj.ayush/benchmark(jfm)/ncep/data/sfc_cf_{init_date}.grib', engine='cfgrib', backend_kwargs={'filter_by_keys': {'shortName': '2t'}})
