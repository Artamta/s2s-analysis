...
This folder supports a **case-study benchmark**:
...
Do not use model-own climatology in this benchmark workflow yet. That avoids
mixing a case-study benchmark with a hindcast-calibrated multi-year hindcast study.
...
The current benchmark workflow expects the 1991-2020 30-year daily and seasonal
