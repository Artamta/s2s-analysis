...
%% -----------------------------------------------------------------------
%%  FONTS  (Palatino body + Helvetica sans for titles = classic preprint)
%% -----------------------------------------------------------------------
...
%% -----------------------------------------------------------------------
%%  PAGE GEOMETRY  (wider text column, generous margins)
%% -----------------------------------------------------------------------
\usepackage[a4paper,
...
%% -----------------------------------------------------------------------
\usepackage{xcolor}
\definecolor{titleband}{RGB}{15,55,120}      % deep navy
\definecolor{accentrule}{RGB}{60,130,200}    % sky blue rule
\definecolor{abstractbg}{RGB}{240,245,252}   % very light blue tint
\definecolor{linkblue}{RGB}{25,85,170}
\definecolor{sectiongray}{RGB}{55,55,65}
...
\fancyhf{}
\fancyhead[L]{%
  \footnotesize\color{sectiongray}\textit{Tamta et al.}\ \
  \textbf{S2S Forecast Benchmark over India (JFM\,2026 \& JJAS\,2019)}}
\fancyhead[R]{\footnotesize\color{sectiongray}\textit{Preprint --- \today}}
\fancyfoot[C]{\small\thepage}
\renewcommand{\headrulewidth}{0.35pt}
\renewcommand{\headrule}{\hbox to\headwidth{\color{accentrule}\leaders\hrule height\headrulewidth\hfill}}
...
%% -----------------------------------------------------------------------
%%  SECTION HEADINGS  (Palatino serif, small-caps numbered, thin rule below)
%% -----------------------------------------------------------------------
\usepackage{titlesec}
\titleformat{\section}
  {\normalfont\large\bfseries\scshape}
  {\thesection.}{0.55em}{}
  [\vspace{2pt}{\color{accentrule!70}\titlerule[0.4pt]}\vspace{1pt}]
...
\titlespacing*{\section}     {0pt}{2.2ex plus 0.5ex minus 0.2ex}{0.6ex}
\titlespacing*{\subsection}  {0pt}{1.4ex plus 0.3ex}{0.3ex}
\titlespacing*{\subsubsection}{0pt}{1.0ex plus 0.2ex}{0.2ex}
...
\usepackage[colorlinks=true,
            ...
            citecolor=linkblue,
            urlcolor=linkblue,
            pdfauthor={Tamta et al.},
            pdftitle={S2S Forecast Benchmark over India}]{hyperref}
...
%% -----------------------------------------------------------------------
%%  TITLE-PAGE MACHINERY
%%  Suppress the default \maketitle; we build a custom title block
%% -----------------------------------------------------------------------
\usepackage{environ}
\makeatletter
% Store \title, \author, \date as usual — we use them in \printpreprint
\newcommand{\preprint@title}{}
\newcommand{\preprint@subtitle}{}
\renewcommand{\title}[2][]{\renewcommand{\preprint@title}{#2}%
                            \renewcommand{\preprint@subtitle}{#1}}
\makeatother

%% -----------------------------------------------------------------------
%%  ABSTRACT ENVIRONMENT  (styled box)
%% -----------------------------------------------------------------------
\usepackage{mdframed}
\newmdenv[
  backgroundcolor=abstractbg,
  linecolor=accentrule,
  linewidth=1.2pt,
...
%% -----------------------------------------------------------------------
%%  AUTHOR HELPER
%%  \auth{Name}{Affil}{Email}
%% -----------------------------------------------------------------------
\newcommand{\auth}[3]{%
  \parbox[t]{0.31\textwidth}{\centering
    {\sffamily\bfseries #1}\\[3pt]
    {\small #2}\\[2pt]
    {\footnotesize\url{#3}}}}

%% -----------------------------------------------------------------------
%%  CUSTOM TITLE BLOCK
%%  Call \printpreprint after \begin{document}
%% -----------------------------------------------------------------------
\newcommand{\printpreprint}[2]{%   #1=main title, #2=subtitle
  \noindent
  \colorbox{titleband}{%
    \parbox{\dimexpr\linewidth-2\fboxsep\relax}{%
      \vspace{9pt}
      \centering
      {\color{white}\sffamily\LARGE\bfseries #1}\\[6pt]
      {\color{accentrule!55!white}\sffamily\large #2}\\[8pt]
      {\color{white!60!titleband}\footnotesize\itshape
        Preprint\enspace\textbullet\enspace\today\enspace\textbullet\enspace
        Not peer reviewed}
      \vspace{8pt}}}%
  \\[-1pt]{\color{accentrule}\rule{\linewidth}{1.2pt}}%
  \vspace{8pt}
}

\title[Weekly Precipitation and Circulation Skill in JFM~2026 and JJAS~2019]%
      {Benchmarking AI and Operational Subseasonal Forecast Systems over India}
...
\printpreprint
  {Benchmarking AI and Operational Subseasonal Forecast Systems over India}
  {Weekly Precipitation and Circulation Skill in JFM\,2026 and JJAS\,2019}

%% --- Author block -------------------------------------------------------
\begin{center}
  \auth{Ayush Raj Tamta}{Ashoka University \& IISER Pune, India}%
       {raj.ayush@students.iiserpune.ac.in}
  \hfill
  \auth{Manmeet Singh}{Western Kentucky University, USA}%
       {manmeet.singh@wku.edu}
  \hfill
  \auth{Saptarishi Dhanuka}{Ashoka University, India}%
       {saptarishi.dhanuka@ashoka.edu.in}
  \\[1.2em]
  \auth{Parthasarathi Mukhopadhyay}{Ashoka University, India}%
       {parthasarathi.mukhopadhyay@ashoka.edu.in}
  \hfill
  \auth{Bedartha Goswami}{IISER Pune, India}%
       {bedartha.goswami@iiserpune.ac.in}
  \hfill
  \auth{Sandeep Juneja}{Ashoka University, India}%
       {sandeep.juneja@ashoka.edu.in}
\end{center}

\vspace{10pt}
{\color{accentrule!40}\rule{\linewidth}{0.4pt}}
\vspace{6pt}

%% --- Abstract -----------------------------------------------------------
\begin{abstractbox}
\noindent{\sffamily\bfseries\small Abstract.}\enspace
...
\vspace{3pt}
\noindent{\sffamily\small\bfseries\color{sectiongray}Keywords:\enspace}%
{\small subseasonal-to-seasonal prediction;
machine-learning weather forecasting; precipitation verification;
India; western disturbances; ensemble forecasting}
\vspace{6pt}
{\color{accentrule!50}\rule{\linewidth}{0.4pt}}
\vspace{2pt}
...
\begin{table}[t]
  ...
  \begin{tabular}{llcccc}
    ...
    FuXi-S2S        & AI (data-driven)       & $1.5^{\circ}$         & 1CF+10PF            & 42\,d & Both \\
    DLESyM          & AI (diffusion-based)   & $0.25^{\circ}$        & 80\,PF              & 48\,d & Both \\
    ECMWF ext-range & Dynamical, coupled     & Tco319 (${\sim}36$km) & 100\,PF             & 46\,d & Both \\
