...
df = pd.read_csv('/home/raj.ayush/s2s/s2s_anlysis/paper_results_pipeline/analysis/tp_regional_wmo.csv')
...
plt.tight_layout()
out_path = '/home/raj.ayush/s2s/s2s_anlysis/paper_results_pipeline/figures/verification/tp_regional_wmo_metrics.png'
