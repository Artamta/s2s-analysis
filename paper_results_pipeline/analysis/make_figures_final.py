...
analysis/skill_per_init.csv (written by compute_skill_horizon_final.py).
...
CSV = '/home/raj.ayush/s2s/s2s_anlysis/paper_results_pipeline/analysis/skill_per_init.csv'
