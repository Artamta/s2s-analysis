...
%% -----------------------------------------------------------------------
%%  SECTION HEADINGS  (sans-serif, navy, with accent rules)
%% -----------------------------------------------------------------------
\usepackage{titlesec}
\titleformat{\section}
  {\sffamily\large\bfseries\color{titleband}}
  {\color{titleband}\thesection.}{0.55em}{}
  [\vspace{1pt}{\color{accentrule}\titlerule[0.6pt]}\vspace{2pt}]
\titleformat{\subsection}
  {\sffamily\normalsize\bfseries\color{sectiongray}}
  {\thesubsection}{0.5em}{}
\titleformat{\subsubsection}
  {\sffamily\small\itshape\color{sectiongray}}
  {\thesubsubsection}{0.5em}{}
\titlespacing*{\section}     {0pt}{2.0ex plus 0.5ex minus 0.2ex}{0.8ex}
\titlespacing*{\subsection}  {0pt}{1.4ex plus 0.3ex}{0.4ex}
...
%% -----------------------------------------------------------------------
\newcommand{\printpreprint}[2]{%   #1=title lines, #2=subtitle line
  % --- top navy band ---
  \noindent
  \colorbox{titleband}{%
    \parbox{\dimexpr\linewidth-2\fboxsep\relax}{%
      \vspace{7pt}
      \centering
      {\color{white}\sffamily\LARGE\bfseries #1}\\[5pt]
      {\color{accentrule!60!white}\sffamily\large #2}
      \vspace{7pt}}}\\[-1pt]
  {\color{accentrule}\rule{\linewidth}{1.2pt}}
  \vspace{6pt}
}
...
\vspace{3pt}
\begin{center}
  \footnotesize\color{sectiongray}
  \textit{Preprint --- \today{} --- Not peer reviewed}
\end{center}
\vspace{4pt}
{\color{accentrule}\rule{\linewidth}{0.4pt}}
\vspace{4pt}
